...
//
//trait HttpServer {
//  def run: ZIO[zio.ZEnv with Has[Port], Throwable, Unit]
//}
//
//
//object HttpServer {
//
//  private case class Live(port: Port) extends HttpServer {
//
...
//
//    override def run: ZIO[zio.ZEnv with Has[Port], Throwable, Unit] = {
